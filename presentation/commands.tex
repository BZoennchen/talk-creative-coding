...
\setlength{\fboxsep}{2pt}  % Padding between image and border


\lstdefinelanguage{JavaScript}{
  keywords={typeof, new, true, false, catch, null, catch, switch, var, in, while, do, case, break, width, height},
  keywordstyle=\color{p5darkkeywordstyle},
  ndkeywords={random, line, export, boolean, throw, implements, import, this},
  emph      = [1]{function, class, return, let, for, <, >, +, /, *, if, else},
  emphstyle = [1]{\color{p5darkidentifierstyle}},
  ndkeywordstyle=\color{p5darkndkeywordstyle},
  identifierstyle=\color{p5darkbasicstyle},
  sensitive=false,
  numberstyle=\color{p5darkbasicstyle},
  comment=[l]{//},
  morecomment=[s]{/*}{*/},
  commentstyle=\color{purple},
  stringstyle=\color{p5darkstringstyle},
  morestring=[b]',
  morestring=[b]"
}
...
\lstset{
   language=JavaScript,
   backgroundcolor=\color{p5darkbackground},
   extendedchars=true,
